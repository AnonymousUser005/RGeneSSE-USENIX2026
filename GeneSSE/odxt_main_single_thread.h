#ifndef GeneSSEMAIN_H
#define GeneSSETMAIN_H
...
/**
 * @brief GeneSSE Setup function
 *
 * @details
 * Executes GeneSSE Setup function
 * 
...
/**
 * @brief GeneSSE Update function
 *
 * @details
 * Executes GeneSSE Update function
 * 
 * @param keyword Keyword to update
 * @param id Document identifier to update
 * @param op Update operation to perform
 */
int GeneSSE_Update(std::string keyword, std::string kw, std::string id, int cnt, unsigned char op);

/**
 * @brief GeneSSE Search function
 *
 * @details
 * Executes GeneSSE Search function
 * 
 * @param query Vector or conjunctive query keywords to search
 */
int GeneSSE_Search(std::unordered_set<std::string> *IdList, std::vector<std::string> query, int update_cnt);
